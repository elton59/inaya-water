            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive ps">
                    ...
                    <td>" . $row['quantity'] . "</td>
                    <td> <a href='confirm_request.php?fpid=$row[id]' class='btn btn-info'>Fill<a>
                     </td>
                    </tbody>
                    ";
                      }
              ...
              <div class="card">
                ...
                if (isset($_GET['fpid'])) {
                  ...
                  $s_vendor=$_SESSION['username'];
                  $vendor = $mysqli->query("select * from vendor where email='$s_vendor'") or die($mysqli->error);
                  $frow = $vendor->fetch_array();
                  $sid = $frow['id'];
                      ...
                      <div class="row justify-content-center ">
                        <div class="form-group">
                          <form method='POST' action='confirm_req_update.php' enctype="multipath/form-data">
                            ...
                            <input type='text' name='sid' value='<?php echo $sid ?>' readonly hidden readonly/></br>
                            ...
                            <label for="location">Price Per item</label>
                            <input type="text" class="form-control" id="location" placeholder="price per item" name="pritem" required><br />
