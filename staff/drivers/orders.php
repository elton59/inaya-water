      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <!--card body-->
                   ...
                   <div class="table-responsive ps">
                    <table id="example2" class="table table-responsive table-hover" id="page1">
                      <thead>
                        ...
                        <th>CUSTOMER FIRSTNAME</th><th>CUSTOMER LAST NAME</th><th>CUSTOMERLOCATION</th><th>DRIVER_NAME</th>
                        <th>DRIVER_PHONENUMBER</th>
                  ...
                  drivers.phone_number AS phone_number
              FROM
                  orders
              JOIN
              ...
              JOIN
                  drivers ON orders.driver_id = drivers.driver_id where order_status='payment_approved' and drivers.email='$cemail'
            ") or die($mysqli->error);
              ...
              while ($row = $result->fetch_assoc()) {
                  echo "
                      ...
                      <td><a href='orders.php?apshpid=".$row['orderid']."' class='btn btn-success'>Delivered</a></td>
                      </tbody>
                  ";
              }
              ?>
...
{
  $id=$_GET['apshpid'];
  $result=$mysqli->query("UPDATE orders set order_status='delivered' where id='$id'") or die($mysqli_error);
...
<div class="card">
            <div class="card-header">
            <h3 class="card-title">Completed Deliveries</h3>
          </div>
          <!--card body-->
                  <div class="class-body">
                   <div class="table-responsive ps">
              ...
              JOIN
                  customers ON customers.customer_id = orders.customer_id
              JOIN
                  drivers ON orders.driver_id = drivers.driver_id where orders.order_status='delivered' and drivers.email='$cemail'
            ") or die($mysqli->error);
